...
public class SecurityConfig {
     ...
     * sea el mismo Keycloak. Ademas del issuer, se valida el claim "azp" contra
     * {@code keycloak.allowed-clients} para que un token emitido para otro cliente del mismo
     * realm no sea aceptado aqui.
     */
    @Bean
